...
static const int attachbelow = 1;    /* 1 means attach after the currently active */
...
static const Key keys[] = {
  ...
  { 0,                            XK_F3,     spawn,          {.v = up_vol } },
	...
	{ MODKEY|ShiftMask,             XK_h,      spawn,          SHCMD("~/Documents/Scripts/Dmenu/keybind-helper.sh") },
	{ MODKEY|ControlMask,           XK_e,      spawn,          SHCMD("~/Documents/Scripts/Dmenu/dmenu-emoji.sh") },
  { MODKEY|ShiftMask,             XK_m,      spawn,          SHCMD("~/Documents/Scripts/Dmenu/mount-media.sh") },
	{ MODKEY|ShiftMask,             XK_p,      spawn,          SHCMD("~/Documents/Scripts/Dmenu/power-menu.sh") },
